import { getCurrentInstance, inject, ref, computed, unref, readonly, hasInjectionContext, nextTick, getCurrentScope, onScopeDispose, shallowRef, watchEffect, version, defineAsyncComponent, defineComponent, h, provide, shallowReactive, watch, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, withCtx, useSSRContext } from 'vue';
...
import { c as createError$1, s as sanitizeStatusCode, h as getContext, i as createHooks, t as toRouteMatcher, k as createRouter$1 } from '../nitro/nitro.mjs';
...
const unhead_7cjzOuCfG9 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "lang-404",
    path: "/:lang()/404",
    component: () => import('./404-QV5cmZtC.mjs')
  },
  {
    name: "lang-download",
    path: "/:lang()/download",
    component: () => import('./download-BigsZKC8.mjs')
  },
  {
    name: "lang-equipment",
    path: "/:lang()/equipment",
    component: () => import('./equipment-B2xfcuOs.mjs')
  },
  {
    name: "lang-home",
    path: "/:lang()/home",
    component: () => import('./home-CW4er9pJ.mjs')
  },
  {
    name: "lang",
    path: "/:lang()",
    component: () => import('./index-DMWtmLxL.mjs')
  },
  {
    name: "lang-moblie-info-id",
    path: "/:lang()/moblie/info-:id()",
    component: () => import('./info-_id_-2KLXI3Kb.mjs')
  },
  {
    name: "lang-post-id.html",
    path: "/:lang()/post/:id().html",
    component: () => import('./_id_.html-CCjW7jKy.mjs')
  },
  {
    name: "lang-search",
    path: "/:lang()/search",
    component: () => import('./search-CXzRPsDU.mjs')
  },
  {
    name: "lang-tag-keyword-page",
    path: "/:lang()/tag/:keyword()/:page()",
    component: () => import('./_page_-38zGQZlF.mjs')
  },
  {
    name: "lang-tag-keyword",
    path: "/:lang()/tag/:keyword()",
    component: () => import('./index-DuXDLeaU.mjs')
  },
  {
    name: "404",
    path: "/404",
    component: () => import('./404-BFbpLoOA.mjs')
  },
  {
    name: "download",
    path: "/download",
    component: () => import('./download-BBu5HObN.mjs')
  },
  {
    name: "equipment",
    path: "/equipment",
    component: () => import('./equipment-CoS6cMdm.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CGPeLyAg.mjs')
  },
  {
    name: "moblie-info-id",
    path: "/moblie/info-:id()",
    component: () => import('./info-_id_-DVZa5JEw.mjs')
  },
  {
    name: "post-id.html",
    path: "/post/:id().html",
    component: () => import('./_id_.html-BtgsqW5v.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-DNQ7Fhjf.mjs')
  },
  {
    name: "tag-keyword-page",
    path: "/tag/:keyword()/:page()",
    component: () => import('./_page_-DSxYnNGJ.mjs')
  },
  {
    name: "tag-keyword",
    path: "/tag/:keyword()",
    component: () => import('./index-BiT7UJqO.mjs')
  }
];
...
const revive_payload_server_QSfJFyvBpM = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_7cjzOuCfG9,
  plugin,
  revive_payload_server_QSfJFyvBpM,
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DtZdwem0.mjs').then((m) => m.default || m)),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B7LUPp8D.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BMZFtZMV.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.15.4_@parcel+watcher@2.5.1_@types+node@22.13.4_db0@0.2.4_ioredis@5.5.0_magicast@_1fd70a66e03eb8cdce476a5a25026baa/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.15.4_@parcel+watcher@2.5.1_@types+node@22.13.4_db0@0.2.4_ioredis@5.5.0_magicast@_1fd70a66e03eb8cdce476a5a25026baa/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { isNumber as A, isClient as B, useGetDerivedNamespace as C, useIdInjection as D, useId as E, isStringNumber as F, isUndefined as G, asyncDataDefaults as H, createError as I, fetchDefaults as J, throwError as K, setPageLayout as L, defaultNamespace as M, useTimeoutFn as N, Yr as Y, Zt as Z, _export_sfc as _, useNuxtApp as a, resolveRouteObject as b, useRuntimeConfig as c, withoutTrailingSlash as d, entry$1 as default, nuxtLinkDefaults as e, useRoute as f, isBoolean as g, hasProtocol as h, injectHead as i, joinURL as j, useNamespace as k, isString as l, noop as m, navigateTo as n, resolveUnref as o, parseQuery as p, tryOnMounted as q, resolveUnrefHeadInput as r, identity as s, tryOnScopeDispose as t, useRouter as u, shared_cjs_prodExports as v, withTrailingSlash as w, debugWarn as x, isElement as y, useZIndex as z };
