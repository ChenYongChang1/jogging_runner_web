...
import { defineComponent, computed, mergeProps, ref, unref, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, openBlock, Fragment, renderList, resolveComponent, renderSlot, getCurrentInstance, inject, createElementBlock, normalizeClass, createCommentVNode, createSlots, watch, provide, toRef, reactive, resolveDynamicComponent, useSlots, Transition, withDirectives, createElementVNode, withModifiers, vShow, Text, nextTick, h, normalizeProps, guardReactiveProps, isRef, normalizeStyle, readonly, useSSRContext } from 'vue';
...
import { w as withInstall, E as ElIcon, d as withNoopInstall, _ as _export_sfc$1, c as addUnit, b as buildProps, e as definePropType, f as buildProp } from './el-popper-CY7jS90x.mjs';
import { _ as _export_sfc, a as useNuxtApp, R as useSwitchLocalePath, S as languageList, n as navigateTo, g as useNamespace, F as useId, f as isBoolean$1, B as useZIndex, P as defaultNamespace, O as throwError, Q as useTimeoutFn, s as shared_cjs_prodExports, k as isNumber$1 } from './server.mjs';
import { b as dropdownItemProps, c as ElCollectionItem$1, e as composeEventHandlers, d as dropdownProps, O as OnlyChild, E as ElTooltip, f as ElCollection$1, g as ElTeleport, h as ElFocusTrap, i as formContextKey, j as formItemContextKey, k as isArray, l as iconPropType, m as isUndefined, C as COLLECTION_ITEM_INJECTION_KEY$1, n as createCollectionWithScope, o as COLLECTION_ITEM_SIGN, p as EVENT_CODE, q as useResizeObserver, r as useEventListener, s as baseGet, t as useAriaProps, w as whenMouse, v as dropdownMenuProps, F as FOCUS_TRAP_INJECTION_KEY, x as COLLECTION_INJECTION_KEY$1, y as FIRST_LAST_KEYS, L as LAST_KEYS } from './dropdown-D5ZlVybY.mjs';
...
var Thumb = /* @__PURE__ */ _export_sfc$1(_sfc_main$e, [["__file", "thumb.vue"]]);
...
var Bar = /* @__PURE__ */ _export_sfc$1(_sfc_main$d, [["__file", "bar.vue"]]);
...
var Scrollbar = /* @__PURE__ */ _export_sfc$1(_sfc_main$c, [["__file", "scrollbar.vue"]]);
...
const _imports_3$1 = "data:image/png;base64,";
const _sfc_main$3 = {
  __name: "header",
  ...
  setup(__props) {
    ...
    const languageName = computed(() => {
      const languageRow = languageList.find((item) => item.value === language.value) || languageList[0];
      return $t(languageRow == null ? void 0 : languageRow.label);
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({
        ...
        style: {
          ...
          borderBottomColor: isEquipment.value ? "#424242" : "#F7F7F7"
        }
      }, _attrs))} data-v-1dc23e58><div class="container-custom tw-px-4 md:tw-px-6" data-v-1dc23e58><div class="tw-flex tw-items-center tw-justify-between tw-py-3 md:tw-py-4 tw-w-full" data-v-1dc23e58><div class="tw-flex tw-items-center tw-space-x-2 md:tw-space-x-3 tw-cursor-pointer" data-v-1dc23e58><img${ssrRenderAttr("src", _imports_0$2)} alt="Logo" class="tw-w-[48px]" data-v-1dc23e58><div data-v-1dc23e58><h1 class="tw-text-base md:tw-text-lg tw-text-[#3EDB30] tw-font-bold tw-text-green-500" data-v-1dc23e58>${ssrInterpolate($t("common.\u8D85\u6162\u8DD1\u8282\u62CD\u5668"))}</h1><div class="tw-text-xs md:tw-text-sm tw-text-[#ccc] tw-text-gray-500" data-v-1dc23e58> chaomanpao.com </div></div></div><nav class="tw-hidden md:tw-flex tw-items-center tw-space-x-6" data-v-1dc23e58><!--[-->`);
      ssrRenderList(menuItems.value, (item) => {
        _push(ssrRenderComponent(_component_nuxt_link, {
          ...
          class: [
            "navBtn",
            isEquipment.value ? "navBtn-equipment" : "",
            { active: currentPath.value === ("getRouteLink" in _ctx ? _ctx.getRouteLink : unref(getRouteLink))(item.path) }
          ]
        }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_dropdown_menu, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(languageList), (item) => {
                    _push3(ssrRenderComponent(_component_el_dropdown_item, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate($t(item.label))}`);
                        } else {
                          return [
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(languageList), (item) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(languageName.value)}`);
                  _push3(ssrRenderComponent(_component_el_icon, { class: "el-icon--right" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_1$1)} alt="" data-v-1dc23e58${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_1$1,
                  ...
                  return [
                    createTextVNode(toDisplayString(languageName.value), 1),
      ...
      _push(`</nav><div class="tw-flex md:tw-hidden tw-items-center tw-justify-center tw-w-[99px] tw-h-[44px] tw-top-[69px] tw-left-[260px] tw-rounded-[14px] tw-border-[1.5px] tw-text-[#4a4a4a] tw-border-[#E5E7EB] tw-pt-[10px] tw-pr-[16px] tw-pb-[10px] tw-pl-[16px] tw-gap-[10px]" data-v-1dc23e58>`);
      if (!isEquipment.value) {
        _push(`<img${ssrRenderAttr("src", _imports_2$1)} alt="menu" class="tw-w-[18px] tw-h-[18px]" data-v-1dc23e58>`);
      } else {
        _push(`<img${ssrRenderAttr("src", _imports_3$1)} alt="menu" class="tw-w-[18px] tw-h-[18px]" data-v-1dc23e58>`);
      }
      _push(`<span class="tw-text-base" style="${ssrRenderStyle({ color: isEquipment.value ? "#fff" : "#4a4a4a" })}" data-v-1dc23e58>${ssrInterpolate($t("common.\u66F4\u591A"))}</span></div></div>`);
      _push(ssrRenderComponent(_component_el_drawer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tw-py-4" data-v-1dc23e58${_scopeId}><!--[-->`);
            ssrRenderList(menuItems.value, (item) => {
              _push2(ssrRenderComponent(_component_nuxt_link, {
                ...
                class: [[
                  ...
                  isEquipment.value ? "navBtn-equipment" : "",
                  { active: currentPath.value === ("getRouteLink" in _ctx ? _ctx.getRouteLink : unref(getRouteLink))(item.path) }
                ], "tw-block tw-py-3 tw-px-4 tw-text-gray-500 hover:tw-bg-green-50 hover:tw-text-green-600 active:tw-bg-green-100 active:tw-text-green-700"],
                        ...
                        ssrRenderList(unref(languageList), (item) => {
                          _push4(ssrRenderComponent(_component_el_dropdown_item, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${ssrInterpolate($t(item.label))}`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString($t(item.label)), 1)
                                ];
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_button, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(languageName.value)} `);
                        _push4(ssrRenderComponent(_component_el_icon, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<img${ssrRenderAttr("src", _imports_1$1)} alt="" data-v-1dc23e58${_scopeId4}>`);
                            } else {
                              return [
                                createVNode("img", {
                                  src: _imports_1$1,
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-1dc23e58"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "download-type tw-mx-[1.67%] tw-rounded-[26px] tw-bg-[#EDFFEE]" }, _attrs))} data-v-fda3bb19><div class="download-type-pc tw-flex tw-items-start tw-justify-around md:tw-items-center md:tw-flex-row-reverse tw-flex-col tw-pl-[4.78%] tw-pt-[45px] tw-pr-[4.2%] max-md:tw-px-[4.2%]" data-v-fda3bb19><div class="left-content" data-v-fda3bb19><div class="download-text tw-flex tw-items-center tw-pb-[20px]" data-v-fda3bb19><div class="tw-mr-[8px] tw-rounded-[2px] tw-w-[8px] tw-h-[8px] tw-bg-[green]" data-v-fda3bb19></div><div class="tw-text-[18px] tw-font-[500]" data-v-fda3bb19>${ssrInterpolate(_ctx.$t("common.\u4E0B\u8F7DAPP"))}</div></div><div class="left-content-header tw-text-[#4A4A4A] dd-fs-48 tw-font-[600] tw-leading-[56px] tw-text-left tw-pb-[17px]" data-v-fda3bb19>${ssrInterpolate(_ctx.$t("common.\u4E0B\u8F7D\u8D85\u6162\u8DD1\u8282\u62CD\u5668"))}</div><div class="download-type-imgs tw-w-full md:tw-w-[386px] tw-pt-[50px] tw-flex tw-flex-wrap" data-v-fda3bb19><div class="download-type-imgs-item tw-w-full md:tw-w-1/2 tw-mb-[10px] md:tw-pr-[8px]" data-v-fda3bb19><img${ssrRenderAttr("src", _imports_0)} class="tw-w-full tw-h-auto" data-v-fda3bb19></div><div class="download-type-imgs-item tw-w-full md:tw-w-1/2 tw-mb-[10px]" data-v-fda3bb19><img${ssrRenderAttr("src", _imports_1)} class="tw-w-full tw-h-auto" data-v-fda3bb19></div><div class="download-type-imgs-item tw-w-full md:tw-w-1/2 tw-mb-[10px]" data-v-fda3bb19><img${ssrRenderAttr("src", _imports_2)} class="tw-w-full tw-h-auto" data-v-fda3bb19></div></div></div><div class="right-content tw-flex tw-jusify-center tw-mr-[20px] max-md:tw-mr-0 tw-items-baseline max-md:tw-transform max-md:tw-translate-x-[-4.2%] tw-relative" data-v-fda3bb19><img${ssrRenderAttr("src", _imports_3)} class="" data-v-fda3bb19><img${ssrRenderAttr("src", _imports_4)} class="tw-absolute tw-left-[58px] tw-h-[100%] tw-top-0" data-v-fda3bb19></div></div></div>`);
    };
  }
});
...
const footerIntroduction = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fda3bb19"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isEquipment = computed(() => {
      var _a;
      return (_a = route.name) == null ? void 0 : _a.includes("equipment");
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["footer-wrapper justify-center items-center w-full lg:tw-mt-[120px] tw-mt-[44px]", [isEquipment.value ? "tw-transform tw-translate-y-[-93px]" : ""]]
      }, _attrs))} data-v-40e78e80><div class="brief-introduction tw-mx-auto" data-v-40e78e80><div class="brief-introduction-pc dd-container sm:tw-flex lg:tw-items-start lg:tw-flex-row-reverse tw-flex-col tw-justify-center lg:tw-mb-[120px]" data-v-40e78e80><div class="right-content lg:tw-w-[40.6%]" data-v-40e78e80><div class="right-content-header max-lg:tw-text-center tw-text-[#4A4A4A] dd-fs-48 tw-font-[600] tw-leading-[56px] tw-text-left tw-pb-[17px]" data-v-40e78e80>${ssrInterpolate(_ctx.$t("common.\u8D85\u6162\u8DD1"))}</div><p class="tw-text-[#666666] tw-text-[18px] tw-font-[500] tw-leading-[28.8px] tw-text-left" data-v-40e78e80>${ssrInterpolate(_ctx.$t(
      ...
      ))}</p></div><img${ssrRenderAttr("src", _imports_0$1)} class="lg:tw-w-[48%] lg:tw-mr-[9.4%] tw-w-full tw-mb-[2rem]" data-v-40e78e80></div></div>`);
      _push(ssrRenderComponent(footerIntroduction, null, null, _parent));
      _push(`<div class="website-approve tw-mx-[24px] tw-mt-[25px] tw-rounded-[26px]" style="${ssrRenderStyle({ "background-color": "#1e293b" })}" data-v-40e78e80><div class="website-approve-pc tw-pt-[93px] tw-pb-[78px] tw-text-center" data-v-40e78e80><p class="tw-text-[#fff] tw-text-[22px] tw-font-[500] tw-leading-[20px] tw-mb-[33px]" data-v-40e78e80> The Wind Technology Co., Ltd. \xA9 2025 All rights reserved. </p><p class="tw-text-[#fff] tw-text-[22px] tw-font-[500] tw-leading-[20px]" data-v-40e78e80>${ssrInterpolate(_ctx.$t("common.\u7F51\u7AD9\u5907\u6848\u53F7\uFF1A\u6CAAICP\u59072024086239\u53F7-2"))}</p></div></div></div>`);
    };
  }
});
...
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-40e78e80"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container tw-flex tw-flex-col tw-w-[100vw] tw-min-h-[100vh]" }, _attrs))}>`);
...
//# sourceMappingURL=default-CytnepfQ.mjs.map
