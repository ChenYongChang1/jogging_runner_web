...
import { ref, resolveComponent, mergeProps, unref, isRef, withCtx, createVNode, createTextVNode, useSSRContext, nextTick } from 'vue';
...
import { g as getRouteLink, s as searchPush } from './comblie-inject-CDusoPZj.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_popover, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="popover-download tw-flex tw-flex-col tw-items-center tw-justify-center"${_scopeId}><img${ssrRenderAttr("src", _imports_0)} class="tw-w-[125px] tw-mb-[5px]" alt=""${_scopeId}><div class="text tw-text-[#4A4A4A] tw-text-[16px] tw-font-[500] tw-leading-[24px]"${_scopeId}> \u626B\u7801\u4E0B\u8F7D\u8D85\u6162\u8DD1 </div></div>`);
          } else {
            return [
      ...
      _push(`</div></div><img${ssrRenderAttr("src", _imports_1)} class="tw-w-[36.1%] max-lg:tw-hidden"></div></div><div class="home-tabar-list-pc tw-grid tw-grid-cols-2 lg:tw-grid-cols-4 tw-gap-4 dd-container tw-transform tw-translate-y-[-75px] max-lg:tw-translate-y-0 tw-mx-auto"><!--[-->`);
      ssrRenderList(unref(tabarList), (item, index) => {
        ...
        _push(`<img${ssrRenderAttr("src", item.icon)} class="tw-w-[85px] max-lg:tw-w-[50px]"></div></div>`);
      });
...
//# sourceMappingURL=index-DMWtmLxL.mjs.map
