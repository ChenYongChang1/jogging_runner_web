...
import { w as withInstall, E as ElIcon, d as withNoopInstall, _ as _export_sfc$1, a as addUnit, b as buildProps, e as definePropType, f as buildProp } from './el-popper-CY7jS90x.mjs';
import { _ as _export_sfc, a as useNuxtApp, R as useSwitchLocalePath, S as languageList, n as navigateTo, g as useNamespace, F as useId, f as isBoolean$1, s as shared_cjs_prodExports, B as useZIndex, P as defaultNamespace, O as throwError, Q as useTimeoutFn, k as isNumber$1 } from './server.mjs';
import { b as dropdownMenuProps, F as FOCUS_TRAP_INJECTION_KEY, C as COLLECTION_INJECTION_KEY$1, c as createCollectionWithScope, e as composeEventHandlers, f as dropdownItemProps, g as ElCollectionItem$1, d as dropdownProps, O as OnlyChild, E as ElTooltip, h as ElCollection$1, i as ElTeleport, j as ElFocusTrap, k as formContextKey, l as formItemContextKey, m as isArray, n as iconPropType, o as isUndefined, p as EVENT_CODE, q as FIRST_LAST_KEYS, L as LAST_KEYS, r as COLLECTION_ITEM_INJECTION_KEY$1, s as COLLECTION_ITEM_SIGN, t as useResizeObserver, v as useEventListener, w as baseGet, x as useAriaProps, y as whenMouse } from './dropdown-D5ZlVybY.mjs';
...
const _imports_1$2 = "" + buildAssetsURL("logo.CP1XCZqi.png");
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-4d531f96><div class="container-custom tw-px-4 md:tw-px-6" data-v-4d531f96><div class="tw-flex tw-items-center tw-justify-between tw-py-3 md:tw-py-4 tw-w-full" data-v-4d531f96><div class="tw-flex tw-items-center tw-space-x-2 md:tw-space-x-3" data-v-4d531f96><img${ssrRenderAttr("src", _imports_1$2)} alt="Logo" class="tw-w-8 tw-h-8 md:tw-w-10 sm\xB7:tw-h-10" data-v-4d531f96><div data-v-4d531f96><h1 class="tw-text-base md:tw-text-lg tw-text-[#3EDB30] tw-font-bold tw-text-green-500" data-v-4d531f96>${ssrInterpolate($t("common.\u8D85\u6162\u8DD1\u8282\u62CD\u5668"))}</h1><div class="tw-text-xs md:tw-text-sm tw-text-[#ccc] tw-text-gray-500" data-v-4d531f96> chaomanpao.com </div></div></div><nav class="tw-hidden md:tw-flex tw-items-center tw-space-x-6" data-v-4d531f96><!--[-->`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_icon, { class: "el-icon--right" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_1$1)} alt="" data-v-4d531f96${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_1$1,
      ...
      _push(`</nav><div class="tw-flex md:tw-hidden tw-items-center tw-justify-center tw-w-[99px] tw-h-[44px] tw-top-[69px] tw-left-[260px] tw-rounded-[14px] tw-border-[1.5px] tw-text-[#4a4a4a] tw-border-[#E5E7EB] tw-pt-[10px] tw-pr-[16px] tw-pb-[10px] tw-pl-[16px] tw-gap-[10px]" data-v-4d531f96>`);
      if (!isEquipment.value) {
        _push(`<img${ssrRenderAttr("src", _imports_2$1)} alt="menu" class="tw-w-[18px] tw-h-[18px]" data-v-4d531f96>`);
      } else {
        _push(`<img${ssrRenderAttr("src", _imports_3$1)} alt="menu" class="tw-w-[18px] tw-h-[18px]" data-v-4d531f96>`);
      }
      _push(`<span class="tw-text-base" style="${ssrRenderStyle({ color: isEquipment.value ? "#fff" : "#4a4a4a" })}" data-v-4d531f96>${ssrInterpolate($t("common.\u66F4\u591A"))}</span></div></div>`);
      _push(ssrRenderComponent(_component_el_drawer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tw-py-4" data-v-4d531f96${_scopeId}><!--[-->`);
            ssrRenderList(menuItems, (item) => {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_el_icon, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<img${ssrRenderAttr("src", _imports_1$1)} alt="" data-v-4d531f96${_scopeId4}>`);
                            } else {
                              return [
                                createVNode("img", {
                                  src: _imports_1$1,
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4d531f96"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "download-type tw-mx-[1.67%] tw-rounded-[26px] tw-bg-[#EDFFEE]" }, _attrs))} data-v-05c830f1><div class="download-type-pc tw-flex tw-items-start tw-justify-around md:tw-items-center md:tw-flex-row-reverse tw-flex-col tw-pl-[4.78%] tw-pt-[45px] tw-pr-[4.2%] max-md:tw-px-[4.2%]" data-v-05c830f1><div class="left-content" data-v-05c830f1><div class="download-text tw-flex tw-items-center tw-pb-[20px]" data-v-05c830f1><div class="tw-pb-[10px] tw-rounded-[6px] tw-w-[10px] tw-h-[10px] tw-bg-[green]" data-v-05c830f1></div><div class="tw-text-[18px] tw-font-[500]" data-v-05c830f1>${ssrInterpolate(_ctx.$t("common.\u4E0B\u8F7DAPP"))}</div></div><div class="left-content-header tw-text-[#4A4A4A] dd-fs-48 tw-font-[600] tw-leading-[56px] tw-text-left tw-pb-[17px]" data-v-05c830f1>${ssrInterpolate(_ctx.$t("common.\u4E0B\u8F7D\u8D85\u6162\u8DD1\u8282\u62CD\u5668"))}</div><div class="download-type-imgs tw-w-full md:tw-w-[386px] tw-pt-[50px] tw-flex tw-flex-wrap" data-v-05c830f1><div class="download-type-imgs-item tw-w-full md:tw-w-1/2 tw-mb-[10px] md:tw-pr-[8px]" data-v-05c830f1><img${ssrRenderAttr("src", _imports_0)} class="tw-w-full tw-h-auto" data-v-05c830f1></div><div class="download-type-imgs-item tw-w-full md:tw-w-1/2 tw-mb-[10px]" data-v-05c830f1><img${ssrRenderAttr("src", _imports_1)} class="tw-w-full tw-h-auto" data-v-05c830f1></div><div class="download-type-imgs-item tw-w-full md:tw-w-1/2 tw-mb-[10px]" data-v-05c830f1><img${ssrRenderAttr("src", _imports_2)} class="tw-w-full tw-h-auto" data-v-05c830f1></div></div></div><div class="right-content tw-flex tw-jusify-center tw-mr-[20px] max-md:tw-mr-0 tw-items-baseline max-md:tw-transform max-md:tw-translate-x-[-4.2%] tw-relative" data-v-05c830f1><img${ssrRenderAttr("src", _imports_3)} class="" data-v-05c830f1><img${ssrRenderAttr("src", _imports_4)} class="tw-absolute tw-left-[58px] tw-h-[100%] tw-top-0" data-v-05c830f1></div></div></div>`);
    };
  }
});
...
const footerIntroduction = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-05c830f1"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const openOrDownloadApp = (str) => {
      (void 0).location.href = str === "open" ? scheme.value : downloadUrl.value;
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_bw_button = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "footer-wrapper justify-center items-center w-full lg:tw-mt-[120px] tw-mt-[44px]" }, _attrs))} data-v-5691c5c7>${ssrInterpolate(unref(isMobileDevice)())} <div class="brief-introduction tw-mx-auto" data-v-5691c5c7><div class="brief-introduction-pc dd-container sm:tw-flex lg:tw-items-start lg:tw-flex-row-reverse tw-flex-col tw-justify-center lg:tw-mb-[120px]" data-v-5691c5c7><div class="right-content lg:tw-w-[40.6%]" data-v-5691c5c7><div class="right-content-header max-lg:tw-text-center tw-text-[#4A4A4A] dd-fs-48 tw-font-[600] tw-leading-[56px] tw-text-left tw-pb-[17px]" data-v-5691c5c7>${ssrInterpolate(_ctx.$t("common.\u8D85\u6162\u8DD1"))}</div><p class="tw-text-[#666666] tw-text-[18px] tw-font-[500] tw-leading-[28.8px] tw-text-left" data-v-5691c5c7>${ssrInterpolate(_ctx.$t(
      ...
      ))}</p></div><img${ssrRenderAttr("src", _imports_0$1)} class="lg:tw-w-[48%] lg:tw-mr-[9.4%] tw-w-full tw-mb-[2rem]" data-v-5691c5c7></div></div>`);
      _push(ssrRenderComponent(footerIntroduction, null, null, _parent));
      _push(`<div class="website-approve tw-mx-[24px] tw-mt-[25px] tw-rounded-[26px]" style="${ssrRenderStyle({ "background-color": "#1e293b" })}" data-v-5691c5c7><div class="website-approve-pc tw-pt-[93px] tw-pb-[78px] tw-text-center" data-v-5691c5c7><p class="tw-text-[#fff] tw-text-[22px] tw-font-[500] tw-leading-[20px] tw-mb-[33px]" data-v-5691c5c7> The Wind Technology Co., Ltd. \xA9 2025 All rights reserved. </p><p class="tw-text-[#fff] tw-text-[22px] tw-font-[500] tw-leading-[20px]" data-v-5691c5c7>${ssrInterpolate(_ctx.$t("common.\u7F51\u7AD9\u5907\u6848\u53F7\uFF1A\u6CAAICP\u59072024086239\u53F7-2"))}</p></div></div><div class="mobile-download tw-w-full tw-h-[58px] tw-flex tw-items-center tw-justify-between" data-v-5691c5c7><div class="tw-flex tw-items-center tw-space-x-2 md:tw-space-x-3" data-v-5691c5c7><img${ssrRenderAttr("src", _imports_1$2)} alt="Logo" class="tw-w-8 tw-h-8 md:tw-w-10 sm\xB7:tw-h-10" data-v-5691c5c7><div data-v-5691c5c7><div class="tw-text-base md:tw-text-lg tw-text-[#3EDB30] tw-font-bold tw-text-green-500" data-v-5691c5c7> \u8D85\u6162\u8DD1\u4E13\u7528APP </div><div class="tw-text-xs md:tw-text-sm tw-text-[#ccc] tw-text-gray-500" data-v-5691c5c7> \u8282\u62CD\u5668\u3001\u6253\u5361\u3001\u66F4\u591A\u5185\u5BB9 </div></div></div><div data-v-5691c5c7>`);
      if (isAppInstalled.value) {
        _push(ssrRenderComponent(_component_bw_button, {
          active: true,
          class: "tw-w-[74px] tw-h-[34px] tw-rounded-[17px]",
          onClick: ($event) => openOrDownloadApp("open")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`\u6253\u5F00`);
        ...
        _push(ssrRenderComponent(_component_bw_button, {
          active: true,
          class: "tw-w-[74px] tw-h-[34px] tw-rounded-[17px]",
          onClick: ($event) => openOrDownloadApp("download")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`\u4E0B\u8F7D`);
...
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5691c5c7"]]);
...
//# sourceMappingURL=default-Uj0FuVaM.mjs.map
