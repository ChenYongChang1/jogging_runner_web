...
import { a as getWatchQueryFunc } from './comblie-inject-CDusoPZj.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dd-container" }, _attrs))} data-v-6d53731c><div class="search-box lg:tw-flex xl:tw-pt-[56px] lg:tw-pt-[44px] ss:tw-pt-[32px]" data-v-6d53731c><div class="search-content" data-v-6d53731c>`);
      ...
      _push(`<!--]--><div class="tw-flex tw-justify-end tw-mt-[42px] max-md:tw-mt-[24px]" data-v-6d53731c>`);
      ...
      _push(`</div></div><div class="lg:tw-w-[33.9%] xl:tw-pl-[52px] lg:tw-pl-[30px]" data-v-6d53731c>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/[lang]/search.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __VUE_DEFAULT__ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d53731c"]]);

export { __VUE_DEFAULT__ as default };
//# sourceMappingURL=search-CXzRPsDU.mjs.map
