...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "tw-w-full tw-h-[300px] dd-fs-42 tw-text-center tw-leading-[300px]" }, _attrs))}>404</div>`);
}
...
//# sourceMappingURL=404-CI30Dv4w.mjs.map
